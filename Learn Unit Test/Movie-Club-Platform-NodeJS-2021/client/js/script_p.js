        ...
        $('#modalInfoContent1').append(`
                    <form id="updateMovieForm">
                        <div class="form-group form-custom">
                            ...
                            <input type="text" id="movieId" class="form-control" value="${
                              data.id
                            }" disabled>
                            <label for="title">Title</label>
                            ...
                            <label for="overview">Overview</label>
                            <textarea id="overview" class="form-control" rows="3">${
                              data.overview
                            }</textarea>
                            <label for="runtime">Runtime</label>
                            <input type="text" id="runtime" class="form-control" value="${
                              data.runtime
                            }">
                            <label for="trailerLink">Trailer Link</label>
                            <input type="text" id="trailerLink" class="form-control" value="${
                              data.trailerLink
                            }">
                            <label for="releaseDate">Release Date</label>
                            <input type="date" id="releaseDate" class="form-control" value="${formatDate(
                              data.releaseDate
                            )}">
                            <label for="poster">Poster</label>
                            <textarea id="poster" class="form-control" rows="3">${
                              data.poster
                            }</textarea>
                            <label for="createdAt">Created At</label>
                            <input type="text" id="createdAt" class="form-control" value="${formatDate(
                              data.createdAt
                            )}" disabled>
                            <div class="modal-actions">
  ...
  $('#movieSearchForm').on('submit', function (e) {
    ...
    $.ajax({
      ...
      success: function (movies) {
        console.log('movies: ', movies)
        if (
          window.location.href === 'http://localhost:4000/src/admins.html' ||
          window.location.href === 'http://localhost:4000/src/admins.html?'
        ) {
        ...
        $('#modalInfoContent1').append(`
                    ...
                    <div class="modal-box">
                        ...
                        <p>
                            ...
                            <span class="tag-info">
                                <a href="${data.trailerLink}" target="_blank">${
          data.trailerLink
        }</a>
                            </span>
                        </p>
                    ...
                    <div data-movieid="${id}" class="modal-box">
                        ...
                        <div id="ratingContent">
                            <p id="ratingText">
                                ...
                                <span id="ratingAverage" class="tag-info">${calculateRatingAverage(
                                  data
                                )}</span>
                            </p>
          ...
          $('#modalInfoContent6').append(
            `
                        <div class="modal-box">
                            ...
                            <div class="card-actions">
                                <button data-id="${element.id}" data-user-id="${
              element.userId
            }" type="button" class="btn btn-success updateReview">Update</button>
                                <button data-id="${element.id}" data-user-id="${
              element.userId
            }" type="button" class="btn btn-danger deleteReview">Delete</button>
                            </div>
        ...
        $('#modalInfoContent1').append(`
                    <form id="createUserForm">
                        <div class="form-group form-custom">
                            ...
                            <input type="date" id="birthday" class="form-control" value="${formatDate(
                              data.birthday
                            )}">
