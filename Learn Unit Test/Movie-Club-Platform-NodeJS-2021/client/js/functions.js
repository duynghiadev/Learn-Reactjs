            ...
            <div class="message">
                ...
                <p>${data.messageInput}
                    ...
                    <span class="messageUpdateDelete">
                        <i data-id="${
                          data.messageId
                        }" data-userid="${data.userId}" class="fas fa-edit messageUpdate" data-toggle="modal" data-target="#modal"></i>
                        <i data-id="${
                          data.messageId
                        }" data-userid="${data.userId}" class="fas fa-trash-alt messageDelete"></i>
                    </span>
                </p>
            </div>
        `)
